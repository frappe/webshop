...
from shop.shop.shopping_cart.cart import _get_cart_quotation, _set_price_list
from erpnext.utilities.product import (get_price)
from shop.shop.utils.product import (get_non_stock_item_status, get_web_item_qty_in_stock)
