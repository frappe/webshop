...
from shop.shop.doctype.shop_settings.test_shop_settings import (
	setup_shop_settings,
)
from shop.shop.doctype.website_item.website_item import make_website_item
from shop.shop.shopping_cart.product_info import get_product_info_for_website
from shop.shop.doctype.override_doctype.item import DataValidationError
from erpnext.stock.doctype.item.test_item import make_item
from shop.shop.doctype.override_doctype.item_group import get_parent_item_groups
...
class TestWebsiteItem(unittest.TestCase):
	...
	def test_index_creation(self):
		...
		from shop.shop.doctype.website_item.website_item import on_doctype_update
	...
	def test_website_item_price_for_logged_in_user(self):
		...
		setup_shop_settings({"show_price": 0})
	...
	def test_website_item_price_for_guest_user(self):
		...
		frappe.set_user("Administrator")
		setup_shop_settings({"hide_price_for_guest": 1})
		frappe.set_user("Guest")
	...
	def test_website_item_stock_when_out_of_stock(self):
		...
		create_regular_web_item()
		setup_shop_settings({"show_stock_availability": 1})
		...
		setup_shop_settings({"show_stock_availability": 0})
		frappe.local.shopping_cart_settings = None
		data = get_product_info_for_website(item_code, skip_quotation_creation=True)
	...
	def test_recommended_item(self):
		...
		setup_shop_settings({"enable_recommendations": 1, "show_price": 1})
		...
		recommended_items = web_item.get_recommended_items(shop_settings)
