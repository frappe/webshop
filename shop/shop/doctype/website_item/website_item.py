...
from shop.shop.doctype.override_doctype.item_group import (
...
from shop.shop.variant_selector.item_variants_cache import (
...
class WebsiteItem(WebsiteGenerator):
	...
	def set_shopping_cart_data(self, context):
		from shop.shop.shopping_cart.product_info import (
...
def has_website_permission_for_website_item(doc, ptype, user, verbose=False):
	...
	if not frappe.db.get_single_value("Shop Settings", "login_required_to_view_products"):
		return True
