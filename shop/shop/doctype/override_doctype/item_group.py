...
class ShopItemGroup(ItemGroup, WebsiteGenerator):
	...
	def validate(self):
		...
		super(ShopItemGroup, self).validate()

	def on_update(self):
		invalidate_cache_for(self)
		super(ShopItemGroup, self).on_update()
	...
	def on_trash(self):
		...
		super(ShopItemGroup, self).on_trash()

	def get_context(self, context):
		context.show_search = True
		context.body_class = "product-page"
		context.page_length = (
			cint(frappe.db.get_single_value("Shop Settings", "products_per_page")) or 6
		)
