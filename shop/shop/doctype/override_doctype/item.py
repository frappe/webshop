...
from shop.shop.doctype.override_doctype.item_group import invalidate_cache_for
...
class ShopItem(Item):
	def on_update(self):
		super(ShopItem, self).on_update()
		invalidate_cache_for_item(self)
		super(ShopItem, self).on_update()

	def before_rename(self, old_name, new_name, merge=False):
		self.validate_duplicate_website_item_before_merge(old_name, new_name)
		return super(ShopItem, self).before_rename(old_name, new_name, merge)
	...
	def after_rename(self, old_name, new_name, merge):
		...
		super(ShopItem, self).after_rename(old_name, new_name, merge)
