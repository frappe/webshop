...
def is_redisearch_enabled():
	...
	is_redisearch_enabled = frappe.db.get_single_value("Shop Settings", "is_redisearch_enabled")
...
def get_fields_indexed():
	fields_to_index = frappe.db.get_single_value("Shop Settings", "search_index_fields")
