...
from shop.shop.doctype.website_item.test_website_item import create_regular_web_item
...
class TestProductDataEngine(unittest.TestCase):
	...
	def test_product_list_discount_filter_builder(self):
		...
		from shop.shop.doctype.website_item.test_website_item import (
			make_web_item_price,
	...
	def test_product_list_with_variants(self):
		...
		setup_shop_settings({"enable_attribute_filters": 0, "hide_variants": 1})
		frappe.local.shopping_cart_settings = None
		...
		# tear down
		setup_shop_settings({"enable_attribute_filters": 1, "hide_variants": 0})
