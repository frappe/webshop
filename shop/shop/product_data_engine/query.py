...
from shop.shop.doctype.item_review.item_review import get_customer
from shop.shop.shopping_cart.product_info import get_product_info_for_website
from shop.shop.utils.product import get_non_stock_item_status
...
class ProductQuery:
	...
	Attributes:
	        ...
	        settings (Document): Shop Settings DocType
	"""
	...
	def get_stock_availability(self, item):
		...
		from shop.templates.pages.wishlist import (
