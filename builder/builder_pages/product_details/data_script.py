...
# price_and_stock = frappe.call("webshop.webshop.shopping_cart.product_info.get_product_info_for_website",item_code=details["item_code"],skip_quotation_creation=True)
