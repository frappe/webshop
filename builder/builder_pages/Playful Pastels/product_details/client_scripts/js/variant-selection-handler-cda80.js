  ...
  fetch(url).then(async (response) => {
    ...
    for (const urls of other_matches) {
      for (const url of urls) {
        ...
        duplicateNode(".slideshow-slide-thumbnail", { src: url });
    ...
    document.dispatchEvent(variantImagesAddedEvent);
  });
}
