...
data.featured_products = homepage_details["featured_products"]
data.no_featured_products = len(homepage_details["featured_products"]) < 1
data.no_collections = len(homepage_details["collections"]) < 1
